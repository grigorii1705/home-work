...
# (show_products, add_to_cart, remove_from_cart, edit_cart_item, 
...
def checkout():
    """Оплатить покупку с учетом скидок и НДС."""
...
# (customer_flow, student_panel, admin_panel, menu остаются без изменений)
