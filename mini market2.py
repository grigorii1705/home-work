#Пользователь может изменить цену существующего товара.
...
# --- Функции магазина (show_products, add_to_cart, show_cart, checkout, remove_from_cart) ---
# (Они не меняются, код тот же, что и в предыдущем ответе)
...
def change_product_price():
    """Изменить цену существующего товара (Админ-панель)"""
    show_products()
    ...
    # Обновляем цену в словаре products
...
def menu():
    ...
    while True:
        ...
        print("7. Изменить цену товара") # Новый пункт меню
        print("8. Выйти") # Изменен номер выхода
        ...
        if choice == "1":
            ...
            change_product_price() # Вызов новой функции
        elif choice == "8":
